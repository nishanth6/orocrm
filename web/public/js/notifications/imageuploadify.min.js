...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
           ...
           //     let container2 = $('<div class="previewImage"></div>');
            ...
            $(self).closest("form").on("submit", function(event) {
                ...
                for (let index = 0; index < inputs.length; ++index) {
                    ...
                    if (!inputs[index].getAttribute("type") || ((inputs[index].getAttribute("type").toLowerCase()) !== "checkbox" && (inputs[index].getAttribute("type").toLowerCase()) !== "radio") || inputs[index].checked) {
