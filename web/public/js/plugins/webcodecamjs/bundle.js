! function(e) {
    ...
    a.active = !1, a.webcam = null, a.canvas = null, a.ctx = null, a.decoder = null, a.setCanvas = function() {
        ...
        var i = "",
            c = !1;
        window.iOS ? a.webcam = document.querySelector("img") : a.webcam = document.querySelector("video"), a.setCanvas(), a.decoder = new Worker(i + "js/plugins/webcodecamjs/decoder.min.js"), window.iOS ? e() : a.webcam.addEventListener("play", function(t) {
            c || (e(), c = !0)
    ...
    function o(e) {
        e || (e = {}), n() && navigator.serviceWorker.register("js/plugins/webcodecamjs/sw.js")
    }
